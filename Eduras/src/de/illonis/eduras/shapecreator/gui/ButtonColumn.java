...
public class ButtonColumn extends AbstractCellEditor implements
	...
	public Component getTableCellRendererComponent(JTable aTable, Object value,
		...
		if (isSelected) {
			renderButton.setForeground(aTable.getSelectionForeground());
			renderButton.setBackground(aTable.getSelectionBackground());
		} else {
			renderButton.setForeground(aTable.getForeground());
