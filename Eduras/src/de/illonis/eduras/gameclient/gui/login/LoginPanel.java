...
class LoginPanel extends JPanel {
	...
	LoginPanel(ListModel<ServerInfo> serverData, ActionListener listener) {
		...
		cc.gridy =0;
		cc.weightx = 1;
		header.add(new JLabel("Servername"), cc);
		cc.gridx = 1;
		header.add(new JLabel("Address"), cc);
		cc.gridx = 2;
		header.add(new JLabel("Port"), cc);
		...
		c.gridy = 1;
		c.gridwidth = 4;
		JLabel serverlistTitle = new JLabel(Localization.getString("Client.login.serverlist"));
		serverlistTitle.setForeground(Color.WHITE);
		form.add(serverlistTitle, c);
		c.gridy = 2;
		form.add(scroll, c);
		c.gridwidth = 1;
		c.gridy = 3;
