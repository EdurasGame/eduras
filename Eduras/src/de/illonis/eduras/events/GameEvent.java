...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), MOVE_LEFT_PRESSED(
				...
				40), SEND_UNITS(41), RESPAWN_PLAYER(42), SPAWN_ITEM(43), HEAL_ACTION(
				...
				302), SET_GAMEMODE(140), SET_INTERACTMODE(141), BASE_CONQUERED(
				142), SET_KILLS(150), SET_DEATHS(151), SET_STATS(152), SET_REMAININGTIME(
				180), SET_TEAMS(191), ADD_PLAYER_TO_TEAM(192), SET_POS_TCP(106), INIT_INFORMATION(
				203), GAME_READY(204), PLAYER_JOINED(207), PLAYER_LEFT(208), SET_ROTATION(
				80), SET_AMMU(125), SET_VISION_ANGLE(107), SET_VISION_RANGE(108), SET_VISION_BLOCKING(
				109), SET_MAP(110), SET_TEAM_RESOURCE(134);
		private int number;
