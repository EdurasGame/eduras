...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), REQUEST_MAP(
				...
				143), SET_KILLS(150), SET_DEATHS(151), SET_STATS(152), SET_REMAININGTIME(
				180), SET_RESPAWNTIME(181), SET_TEAMS(191), ADD_PLAYER_TO_TEAM(
				192), SET_POS_TCP(106), INIT_INFORMATION(203), GAME_READY(204), INFO_PLAYER_JOIN(
