...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), MOVE_LEFT_PRESSED(
				...
				44), CREATE_UNIT(45), SET_POS_UDP(101), SET_OWNER(102), SET_VISIBLE(
				...
				141), BASE_CONQUERED(142), ITEM_USE_FAILED(143), SET_KILLS(150), SET_DEATHS(
				151), SET_STATS(152), SET_REMAININGTIME(180), SET_RESPAWNTIME(
				181), SET_TEAMS(191), ADD_PLAYER_TO_TEAM(192), SET_POS_TCP(106), INIT_INFORMATION(
