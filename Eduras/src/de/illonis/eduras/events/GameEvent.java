...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INFORMATION_REQUEST(1), CLIENT_SETNAME(2), MOVE_LEFT_PRESSED(10), MOVE_RIGHT_PRESSED(11), MOVE_UP_PRESSED(
				12), MOVE_DOWN_PRESSED(13), MOVE_LEFT_RELEASED(14), MOVE_RIGHT_RELEASED(
				15), MOVE_UP_RELEASED(16), MOVE_DOWN_RELEASED(17), SETSPEEDVECTOR(
				18), SETSPEED(19), SET_POS(101), OBJECT_CREATE(120), OBJECT_REMOVE(
				121), SHOOT_PRESSED(30), SHOOT_RELEASED(31), DEATH(131), SETHEALTH(
				132), NO_EVENT(99);
