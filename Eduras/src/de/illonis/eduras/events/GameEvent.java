...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), REQUEST_MAP(
				...
				191), ADD_PLAYER_TO_TEAM(192), ADD_OBJECT_TO_TEAM(193), SET_POS_TCP(
				106), INIT_INFORMATION(203), GAME_READY(204), INFO_PLAYER_JOIN(
				205), INFO_PLAYER_LEFT(206), PLAYER_JOINED(207), PLAYER_LEFT(
				208), SET_SETTINGS(209), SET_SETTINGPROPERTY(210), SET_ROTATION(
				80), SET_AMMU(125), SET_VISION_ANGLE(107), SET_VISION_RANGE(108), SET_VISION_BLOCKING(
				109), SET_MAP(110), SET_SIZE(111), SET_TEAM_RESOURCE(134), SET_AVAILABLE_BLINKS(
				135), SPELL_SCOUT(401), SEND_MAP(501);
		private int number;
