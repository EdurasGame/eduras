...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), MOVE_LEFT_PRESSED(
				...
				16), MOVE_DOWN_RELEASED(17), SET_SPEEDVECTOR(18), SET_SPEED(19), BLINK(
				20), SWITCH_INTERACTMODE(40), SEND_UNITS(41), RESURRECT_PLAYER(
				42), SPAWN_ITEM(43), HEAL_ACTION(44), CREATE_UNIT(45), SPEED_SPELL(
				46), INVISIBILITY_SPELL(47), SET_POS_UDP(101), SET_OWNER(102), SET_VISIBLE(
				103), SET_COLLIDABLE(104), SET_POLYGON_DATA(105), OBJECT_CREATE(
				120), OBJECT_REMOVE(121), SET_ITEM_SLOT(122), ITEM_CD_START(123), ITEM_CD_FINISHED(
				124), ITEM_USE(30), INFO_RESPAWN(130), DEATH(131), SET_HEALTH(
				132), SET_MAXHEALTH(133), MATCH_END(190), START_ROUND(189), NO_EVENT(
				99), MISSILE_LAUNCH(301), LOOT_ITEM_EVENT(302), SET_GAMEMODE(
