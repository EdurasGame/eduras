...
public abstract class GameEvent extends Event {
	...
	public enum GameEventNumber {
		INVALID_NUMBER(-1), INFORMATION_REQUEST(1), CLIENT_SETNAME(2), MOVE_LEFT_PRESSED(
				...
				46), INVISIBILITY_SPELL(47), BLINK_SPELL(48), SET_POS_UDP(101), SET_OWNER(
				...
				109), SET_MAP(110), SET_SIZE(111), SET_RENDER_INFO(112), SET_TEAM_RESOURCE(
				134), SET_AVAILABLE_BLINKS(135), SPELL_SCOUT(401);
		private int number;
